...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <SunDoodle className="absolute top-24 right-[6%] w-16 ink-stroke night:hidden" data-parallax="2" />
      <MoonDoodle className="absolute top-24 right-[6%] w-16 ink-stroke hidden night:block" data-parallax="2" />
